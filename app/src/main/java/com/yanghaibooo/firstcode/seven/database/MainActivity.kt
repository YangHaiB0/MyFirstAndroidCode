package com.yanghaibooo.firstcode.seven.database
...
import kotlinx.android.synthetic.main.activity_seven_database_main.*

class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_seven_database_main)
